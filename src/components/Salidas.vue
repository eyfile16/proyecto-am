<template>
    <q-page padding>
      <div class="text-h4 text-primary text-center q-mb-lg">Gestión de Inventario - Salidas</div>
      ...
      <q-dialog v-model="showModal" persistent maximized>
        <q-card class="column" style="width: 900px; max-width: 95vw;">
          <q-card-section class="bg-primary text-white">
            <div class="text-h6">{{ isEditMode ? 'Editar Salida' : 'Nueva Salida' }}</div>
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-md-6">
                  <q-input
                    ...
                    filled
                    :rules="[val => !!val || 'Número de documento requerido']"
                  />
                </div>
                <div class="col-12 col-md-6">
                  <q-input
          ...
          <q-td :props="props" class="text-center">
            <q-btn-group flat>
              <q-btn
                ...
                size="sm"
              >
                <q-tooltip>Editar salida</q-tooltip>
              </q-btn>
              <q-btn
  ...
  async function loadEntries() {
    try {
      ...
      if (response && response.salidas) { 
        inventoryEntries.value = [...response.salidas];
      }
    } catch (error) {
